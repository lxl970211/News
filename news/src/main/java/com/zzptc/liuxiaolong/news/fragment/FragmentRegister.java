...
public class FragmentRegister extends Fragment{
     ...
     * @param hansFocus
     */
    @Event(value = {R.id.et_register_confirmPwd, R.id.et_register_pwd, R.id.et_register_userName, R.id.et_register_email, R.id.et_enterCodes}, type = View.OnFocusChangeListener.class)
        ...
        if (!hansFocus){
            switch (v.getId()){
                ...
                case R.id.et_enterCodes:
                        ...
                        if (enterCodes.getText().toString().equals(codeUtils.getCode())) {
                            codescorrect = false;
    ...
    private void getEvent(View v){
        ...
        if (verificationform()){
            ...
            user.setUser_pwd(reg_pwd.getText().toString());
